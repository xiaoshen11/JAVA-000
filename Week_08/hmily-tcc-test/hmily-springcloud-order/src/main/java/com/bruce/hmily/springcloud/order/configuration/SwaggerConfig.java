...
package com.bruce.hmily.springcloud.order.configuration;
...
public class SwaggerConfig {
    ...
    private static final String SWAGGER_SCAN_BASE_PACKAGE = "com.bruce.hmily.springcloud.order.controller";
